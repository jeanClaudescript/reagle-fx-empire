  ...
  return (
    <ConfirmContext.Provider value={value}>
      ...
      {createPortal(
        <AnimatePresence>
          {state?.open && (
            <div className="modal-shell modal-shell--confirm" role="presentation">
              <motion.button
                type="button"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                className="modal-shell__backdrop admin-confirm-backdrop"
                onClick={() => close(false)}
              ...
              <motion.div
                ...
                className="admin-confirm-panel modal-shell__panel p-6 sm:p-7"
              >
                <div
